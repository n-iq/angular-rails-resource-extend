angular.module 'rails.extend.extensions', [
  'rails.extend.extensions.array'
  'rails.extend.extensions.permission'
  'rails.extend.extensions.attribute'
  'rails.extend.extensions.permission'
  'rails.extend.extensions.flash'
]
